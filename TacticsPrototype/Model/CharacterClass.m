...
+ (CharacterClass *)grunt
{
    ...
    dude.strPerAtk = 1;
    dude.magicPerAtk = 0;
    dude.critDmgPerAtk = 2;
    dude.armorPerDef = 0.8;
    dude.resPerDef = 0.4;
    dude.maxHpPerDef = 0.75;
    dude.accPerSkill = 1;
    dude.dodgePerSkill = 1;
    dude.critChancePerSkill = 0.2;
...
+ (CharacterClass *)shaman
{
    ...
    dude.strPerAtk = 0;
    dude.magicPerAtk = 0.9;
    dude.critDmgPerAtk = 2;
    dude.armorPerDef = 0.5;
    dude.resPerDef = 1.25;
    dude.maxHpPerDef = 0.9;
    dude.accPerSkill = 1.2;
    dude.dodgePerSkill = 0.85;
    dude.critChancePerSkill = 0.2;
